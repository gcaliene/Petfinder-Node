	...
	$("#submit").on('click', function(){
		...
		$.ajax({
			...
			success: function(newPost) {
				$posts.append('<li> <button type="button" id="deleteButton"> Delete</button> <button type="button" id="updateButton">Update</button> text: ' + post.text + " name: " + post.userName + '  at ' + Date(post.created) + ' </li>');
			},
			error: function(){
				alert('Couldn\'t load previous posts!');
			},

...
/////////////////////DELETE///////////////////////	
	$posts.delegate("#deleteButton","click", function(){ //have to use delegate instead of on click to work, i forgot why.
		var $li = $(this).closest("li");
		console.log("Sending request to Ajax to delete post"); 
		console.log(ajaxUser + "from delete!");
		console.log($(this).closest("li").find("span.name").val());
...
////////////////////////////PUT//////////////////////////
	$posts.delegate(".editPost", "click", function() { //have to use delegate instead of on click to work, i forgot why.
		var $li = $(this).closest("li");
		if(ajaxUser===$li.find("span.name").text()){
